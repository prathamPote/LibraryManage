...
class maincode:
    ...
    def cur(self):
        ...
        self.develop = Label(self.fm3, text='Developed By - Team 11', bg='#fff', fg='blue',
    ...
    def addbook(self):
        class temp(maincode):
            ...
            def book(self):
                ...
                self.bt = Button(self.fm1, text='Submit', width=41, bg='red', fg='#fff', font=('Arial', 10, 'bold'),
                                 bd=5,
    ...
    def issuebook(self):
        class test(maincode):
            ...
            def issue(self):
                ...
                self.lc = Label(self.ffb, text='STUDENT  INFORMATION', bg='#0f624c', fg='#fff',
                                font=('Arial', 12, 'bold'))
                ...
                self.bt3 = Button(self.fc, text='Clear', width=14, bg='blue', fg='#fff', font=('arial', 10, 'bold'),
                                  bd=5,
            ...
            def data(self):
                ...
                if self.value != None:
                    if self.max == 0:
                        ...
                        self.lbn = Label(self.boot, text=self.value[1], bg='#fff', fg='black',
                                         font=('Arial', 10, 'bold'))
            ...
            def yes(self):
                ...
                self.bt1 = Button(self.fr, text='Submit', width=35, bg='#0f624c', fg='#fff', font=('Arial', 10,
                                                                                                   'bold'), bd=5,
                                  relief='flat', command=self.data, state=ACTIVE)
                self.bt1.place(x=60, y=160)
    ...
    def edit(self):
        class editing(maincode):
            ...
            def savedit(self):
                ...
                cursor = dd.cursor()
                cursor.execute(
                    "UPDATE stbook SET Book_ID='" + self.id + "', Title='" + self.ti + "',Author='" + self.au + "',Edition='" + self.ed + "',Price='" + self.pi + "' WHERE Book_ID='" + self.datas + "'")
                dd.commit()
    ...
    def search(self):
        class demt(maincode):
            def delmdata(self):
                ...
                self.backbt = Button(self.fc, width=60, bg='#a7ecd9', activebackground='#a7ecd9', bd=0, relief='flat',
                                     command=self.cur)
                self.backbt.place(x=0, y=0)
                self.log = PhotoImage(file='back.png')
                self.backbt.config(image=self.log, compound=LEFT)
    ...
    def code(self):
        ...
        self.btn1 = Button(self.fm1, text='  login', fg='white', bg='red', width=100, font=('Arial', 11, 'bold'),
                           activebackground='white', activeforeground='black', command=self.login, bd=3, relief='flat',
                           cursor='hand2')
